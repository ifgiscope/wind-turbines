...
function fiveCars(city, carOverlay) {
  ...
  carOverlay.addCar(
    new Car(
      carOverlay,
      carOverlay.textures["bus-yellow"],
      14,
      0,
      "N",
      RoadTile.INNER_LANE
